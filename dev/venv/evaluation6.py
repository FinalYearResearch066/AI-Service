...
def prepare_evaluation_data():
    ...
    model_path = os.path.join(base_dir, "gru_attention_focal_model10_4.h5")
    func_enc_path = os.path.join(base_dir, "func_encoder10_4.pkl")
    user_enc_path = os.path.join(base_dir, "user_encoder10_4.pkl")
    time_enc_path = os.path.join(base_dir, "time_encoder10_4.pkl")
