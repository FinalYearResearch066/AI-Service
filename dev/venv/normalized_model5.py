...
# =========================
# 1️⃣ Load dataset - bidirectional nodes, learnng rate
# =========================
...
# 9️⃣ Save model
# =========================
model.save('gru_next_function_model5.h5')

with open('func_encoder5.pkl','wb') as f:
    pickle.dump(func_enc,f)

with open('user_encoder5.pkl','wb') as f:
    pickle.dump(user_enc,f)

with open('time_scaler5.pkl','wb') as f:
