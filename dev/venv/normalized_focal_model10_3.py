...
model.save('gru_focal_loss_model10_3.h5')

with open('func_encoder10_31.pkl', 'wb') as f:
    pickle.dump(func_enc, f)
with open('user_encoder10_31.pkl', 'wb') as f:
    pickle.dump(user_enc, f)
with open('time_encoder10_31.pkl', 'wb') as f:
