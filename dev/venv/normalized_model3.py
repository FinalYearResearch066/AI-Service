...
csv_path = os.path.join(BASE_DIR, '..', 'gru_dataset_5000_rows.csv')
...
# 9️⃣ Save model
# =========================
model.save('gru_next_function_model3.h5')

with open('func_encoder3.pkl','wb') as f:
    pickle.dump(func_enc,f)

with open('user_encoder3.pkl','wb') as f:
    pickle.dump(user_enc,f)

with open('time_scaler3.pkl','wb') as f:
