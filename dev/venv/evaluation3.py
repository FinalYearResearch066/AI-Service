...
def prepare_evaluation_data():
    ...
    model_path = os.path.join(base_dir, "gru_focal_loss_model10copy.h5")
    func_enc_path = os.path.join(base_dir, "func_encoder10copy.pkl")
    user_enc_path = os.path.join(base_dir, "user_encoder10copy.pkl")
    time_enc_path = os.path.join(base_dir, "time_encoder10copy.pkl")
