...
def build_sequence_model(num_funcs, num_users, seq_len, time_features=4):
    ...
    emb_f = layers.Embedding(num_funcs,32)(in_func)
...
# 9️⃣ Save model
# =========================
model.save('gru_next_function_model2.h5')

with open('func_encoder2.pkl','wb') as f:
    pickle.dump(func_enc,f)

with open('user_encoder2.pkl','wb') as f:
    pickle.dump(user_enc,f)

with open('time_scaler2.pkl','wb') as f:
