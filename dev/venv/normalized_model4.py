...
csv_path = os.path.join(BASE_DIR, '..', 'gru_dataset.csv')
...
# 9️⃣ Save model
# =========================
model.save('gru_next_function_model4.h5')

with open('func_encoder4.pkl','wb') as f:
    pickle.dump(func_enc,f)

with open('user_encoder4.pkl','wb') as f:
    pickle.dump(user_enc,f)

with open('time_scaler4.pkl','wb') as f:
